/**
 * Canonical TypeScript template for the OpenCode custom tools file.
 *
 * This is the source of truth for the tools output. The shell script
 * `commands/tools.sh` is generated from this template at build time
 * by `generate-tools-sh.ts`.
 *
...
/**
 * Renders the complete tools TypeScript file with placeholders resolved.
 * Used by tests to validate structure; the shell generator uses the
...
/**
 * List of expected export names — used by tests to validate completeness.
 */
